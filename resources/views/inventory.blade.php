...
<head>
    ...
    <title>MBG - Manajemen Bahan Baku</title>
...
<body class="bg-[#F8FAFC]">
    ...
    <nav class="bg-white shadow-sm py-4 px-10 flex justify-between items-center sticky top-0 z-50">
        ...
        <div class="flex gap-8 items-center font-medium text-gray-600">
            ...
            <a href="{{ url('/inventories') }}" class="bg-[#113F67] text-white px-4 py-2 rounded-full text-sm shadow-md">Bahan Baku</a>
    ...
    <header class="max-w-[1400px] mx-auto mt-10 px-10">
        <div class="flex justify-between items-end">
            <div>
                <h2 class="text-4xl font-black text-[#113F67]">Stok Bahan Baku</h2>
                <p class="text-gray-500 mt-2">Monitoring ketersediaan logistik pangan di seluruh unit dapur.</p>
            </div>
            <a href="{{ url('/kelola/inventory') }}" class="bg-[#33A1E0] text-white px-6 py-3 rounded-2xl font-bold flex items-center gap-2 hover:bg-[#113F67] transition-all shadow-lg">
                <i class="fa-solid fa-box-open"></i> Kelola Stok
            </a>
        </div>
    </header>
    ...
    <main class="max-w-[1400px] mx-auto p-10">
        <div id="inventory-container" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
            <div class="col-span-full py-20 text-center opacity-50">
                ...
                <p class="text-[#113F67] font-bold italic">Menghubungkan ke database db_inventory...</p>
            </div>
        </div>
    </main>
